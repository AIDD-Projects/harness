...
> **v0.8.3** — 6개 IDE 지원, Navigation Dispatcher, 5개 파이프라인 (🟢🔵🔴🟡🟣), Crew Artifact Integration, 100점 품질 감사.
...
Musher는 현재 **v0.8.3** — 6개 IDE 지원 완료, Navigation Dispatcher와 Crew Artifact Integration 안정화.
