...
v0.10부터는 **Common Mode Confidence Loop**가 추가됩니다. 러프한 목표를 짧은 Goal Card로 좁히고, 기능이 실제로 동작함을 보여줄 proof를 먼저 계획하며, 긴 네비게이터 설명보다 테스트/스모크 증거를 기준으로 진행합니다.
...
kode:harness는 현재 **v0.10.0** — Common Mode Confidence Loop를 추가했습니다: Goal Card, Quiet Navigator, Evidence-Gated Progress Board, Proof Ledger. v0.9.7은 drift 가드, README 위치 안내, IDE 가이드, reviewer working-proof 게이트를 추가했습니다.
...
| **Confidence Loop** | v0.10.0 | ✅ 현재 | Goal Card, Quiet Navigator, Evidence-Gated Progress Board, Proof Ledger, QA/content 회귀 테스트 |
